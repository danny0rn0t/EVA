...
class MyDataset(Dataset):
  ...
  def __getitem__(self, index):
    ...
    speech, _ = librosa.load(f"./Raw/Wavs/{id['video_id']}_{id['clip']}.wav", sr=16000, mono=True)
    import math
...
class Classifier(nn.Module):
  def __init__(self):
    ...
    configuration = HubertConfig(num_labels = 7, use_weighted_layer_sum=True, classifier_proj_size=32)
